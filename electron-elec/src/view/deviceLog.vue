...
const {  cardArray } = storeToRefs(store)
// console.log(cardArray)


// watch(store.logMessage, (newVal, oldVal) => {
//     getTableData()
// });
...
function getTableData() {
    // console.log("12")
    tableData.arr = store.logMessage.slice(
        (currentPage.value - 1) * pageSize.value,
        currentPage.value * pageSize.value
    );
    
    
    // const res = await getCurrentPageData(currentPage, pageSize)
    // tableData.push(...res)
